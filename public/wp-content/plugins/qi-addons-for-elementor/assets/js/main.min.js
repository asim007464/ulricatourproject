    ...
    var P = {
            ...
            getOptions: function(e) {
                var o = void 0 !== e.data("options") ? e.data("options") : {},
                    ...
                    x = void 0 !== o.slidesPerView768 && "" !== o.slidesPerView768 ? parseInt(o.slidesPerView768, 10) + n : "auto" === o.slidesPerView ? "auto" : 2 + n,
                ...
                if (m || (s < 2 ? x = A = y = C = q = s : s < 3 ? A = y = C = q = s : s < 4 ? y = C = q = s : s < 5 && (C = q = s)), "never" !== i) switch (i) {
                    case 1024:
                        A = Math.floor(A);
                    case 768:
                        x = Math.floor(x);
    ...
    var n = {
        ...
        generateChartData: function(e, o) {
            ...
            return r.forEach(function(e, o) {
                var t = {};
                t.data = r[o].split(","), t.label = a[o], t.backgroundColor = l[o], t.hoverBackgroundColor = f[o], t.borderColor = c[o], t.hoverBorderColor = h[o], t.borderWidth = u, t.hoverBorderWidth = q, t.pointBackgroundColor = "rgba(0,0,0,0)", t.pointBorderColor = "rgba(0,0,0,0)", t.pointHoverBackgroundColor = "rgba(0,0,0,0)", t.pointHoverBorderColor = "rgba(0,0,0,0)", t.cubicInterpolationMode = "default", t.fill = i[o], t.barPercentage = _, t.categoryPercentage = m, t.tension = d[o], I.push(t)
...
function(e) {
    ...
    var o, t = qodefAddonsCore.windowHeight,
        s = (e(document).ready(function() {
            s.init()
        }), e(window).resize(function() {
            clearTimeout(o), o = setTimeout(() => {
                100 < Math.abs(qodefAddonsCore.windowHeight - t) && s.init(), t = qodefAddonsCore.windowHeight
            }, 200)
        }), {
            init: function() {
